...
snakemake --rerun-incomplete -p --use-conda preprocess_egyptgsa preprocess_egyptgsapso preprocess_egyptwgs preprocess_lazaridis preprocess_busby  preprocess_1000g  preprocess_fernandes preprocess_scott preprocess_bergstroem
